...
public class Valopre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_valopre);
        ...
        drawerLayout = (DrawerLayout) findViewById(R.id.contenedorPrincipales);
        listView = (ListView) findViewById(R.id.menuIzqes);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                switch (i){
                    case(0): Intent intent=new Intent(Valopre.this,Main.class);
                        startActivity(intent);


                        break;
                    case(1):Intent intent1=new Intent(Valopre.this,Perfil.class);
                    ...
                    case(2):
                        ...
                        break;
                    case(3):
                        Intent intent2= new Intent(Valopre.this, Clasificacion.class);
                        startActivity(intent2);
                        break;
                    case(4):
                        Intent intent3= new Intent(Valopre.this, Loggin.class);
                        editor.putInt("var",-1);
                        editor.commit();
        ...
        vp = (ViewPager) findViewById(R.id.Pager20);
        vp.setAdapter(page1);
    ...
    public class PagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position){
                case 0 : return new ValpreFragment(a);
                case 1 : return new ValpreFragment(b);
                case 2 : return new ValpreFragment(c);
                default: return null;
            }
