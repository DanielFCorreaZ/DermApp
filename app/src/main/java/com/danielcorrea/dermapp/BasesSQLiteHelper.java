...
public class BasesSQLiteHelper extends SQLiteOpenHelper {
    ...
    public BasesSQLiteHelper(Context context, String name, SQLiteDatabase.CursorFactory factory, int version) {
